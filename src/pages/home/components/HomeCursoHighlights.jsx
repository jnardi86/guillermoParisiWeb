    ...
    <div ref={ref} className="w-full flex flex-col m-auto tablet:w-3/4 mt-20">
      ...
      <div className="w-full mt-10 flex flex-wrap">
        ...
        {highlights.map((highlight) => (
          ...
          >
            <p className="font-Poppins text-center font-Bold text-DarkCharcoal text-5xl">
              {highlight.value}
            </p>
            <p className="font-Poppins text-sm text-center text-DarkCharcoal laptop1:text-base pt-3">
