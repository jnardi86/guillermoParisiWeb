  ...
  return (
    <div className="w-full tablet:w-3/4 laptop1:w-1/2 laptop2:w-1/3 m-auto rounded-lg bg-White shadow-lg p-6 mt-20 mb-20">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="w-full block font-Poppins text-base text-DarkBlue font-Semibold mb-2" htmlFor="fechaCurso">
            Fecha del Curso
          </label>
          <select
            id="fechaCurso"
          ...
          >
            ...
            <option
              className="font-Poppins text-base"
              value="2-6/12">
              2 al 6 de Diciembre 2024</option>
          </select>
        </div>

        <div>
          <label className="block font-Poppins text-base text-DarkBlue font-Semibold mb-2" htmlFor="consultas">
            Consultas
          </label>
          <textarea
            id="consultas"
